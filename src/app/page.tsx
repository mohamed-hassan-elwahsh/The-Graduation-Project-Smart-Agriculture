...
export default function App() {
  ...
  const { phase, location, governorate, progress, currentStep, data, startAnalysis, startImageAnalysis, resetAnalysis } = useAnalysis();

  const t = TR[lang];
  const toggleLang = () => setLang(l => l === 'en' ? 'ar' : 'en');

  if (phase === 'search') return <SearchView t={t} lang={lang} onLangToggle={toggleLang} onSearch={startAnalysis} onImageUpload={startImageAnalysis} />;
